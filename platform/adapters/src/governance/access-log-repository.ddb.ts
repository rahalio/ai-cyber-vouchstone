/**
 * AccessLogRepository - DynamoDB Implementation
 *
...
/**
 * AccessLogRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing AccessLog repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { AccessLogRepository } from "@vouchstone/services/governance";
...
/**
 * AccessLogRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: ACCESSLOG
 * Entity Token: ACCESSLOG
 * SK Prefix: ACCESSLOG
 */
export class AccessLogRepositoryDdb implements AccessLogRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "ACCESSLOG";
  private readonly ENTITY_TOKEN = "ACCESSLOG";
  private readonly SK_PREFIX = "ACCESSLOG";
  private readonly IS_CHILD_ENTITY = false;
  private readonly CREATED_AT_FIELD = "at";
  private readonly UPDATED_AT_FIELD = "updatedAt";
  private readonly SOFT_DELETE_ENABLED = false;
  private readonly DOMAIN = "GOVERNANCE";
  private readonly ENTITY_TYPE_PK = "ACCESSLOGS";
