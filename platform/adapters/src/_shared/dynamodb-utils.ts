 ...
 *
 * @returns The core table name (e.g., "vouchstone-core-dev")
 ...
 *
 * @returns The base table name (e.g., "vouchstone-base-dev")
 ...
 *
 * @returns The analytics table name (e.g., "vouchstone-analytics-dev")
 ...
 *
 * @returns The realtime table name (e.g., "vouchstone-app-realtime-dev")
