 ...
 *
 * DDD: Infrastructure adapter implementing Finding repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { FindingRepository } from "@vouchstone/services/findings";
...
/**
 * FindingRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: FINDING
 * Entity Token: FINDING
 * SK Prefix: FINDING
 */
export class FindingRepositoryDdb implements FindingRepository {
  ...
  private readonly ENTITY_TYPE = "FINDING";
  private readonly ENTITY_TOKEN = "FINDING";
  private readonly SK_PREFIX = "FINDING";
  private readonly IS_CHILD_ENTITY = false;
  private readonly CREATED_AT_FIELD = "dueDate";
  private readonly UPDATED_AT_FIELD = "dueDate";
  private readonly SOFT_DELETE_ENABLED = false;
  private readonly DOMAIN = "FINDINGS";
  private readonly ENTITY_TYPE_PK = "FINDINGS";
  private generateCorrelationId(): string {
    const domainPrefix = "fnd";
