/**
 * ExerciseRepository - DynamoDB Implementation
 *
...
/**
 * ExerciseRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing Exercise repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { ExerciseRepository } from "@vouchstone/services/exercises";
...
/**
 * ExerciseRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: EXERCISE
 * Entity Token: EXERCISE
 * SK Prefix: EXERCISE
 */
export class ExerciseRepositoryDdb implements ExerciseRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "EXERCISE";
  private readonly ENTITY_TOKEN = "EXERCISE";
  private readonly SK_PREFIX = "EXERCISE";
  private readonly IS_CHILD_ENTITY = false;
  private readonly CREATED_AT_FIELD = "dueDate";
  private readonly UPDATED_AT_FIELD = "executedAt";
  private readonly SOFT_DELETE_ENABLED = false;
  private readonly DOMAIN = "EXERCISES";
  private readonly ENTITY_TYPE_PK = "EXERCISES";
  private generateCorrelationId(): string {
    const domainPrefix = "exr";
