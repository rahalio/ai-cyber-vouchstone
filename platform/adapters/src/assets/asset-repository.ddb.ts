/**
 * AssetRepository - DynamoDB Implementation
 *
 ...
 * AssetRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing Asset repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { AssetRepository } from "@vouchstone/services/assets";
...
/**
 * AssetRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: ASSET
 * Entity Token: ASSET
 * SK Prefix: ASSET
 */
export class AssetRepositoryDdb implements AssetRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "ASSET";
  private readonly ENTITY_TOKEN = "ASSET";
  private readonly SK_PREFIX = "ASSET";
  ...
  private readonly ENTITY_TYPE_PK = "ASSETS";
