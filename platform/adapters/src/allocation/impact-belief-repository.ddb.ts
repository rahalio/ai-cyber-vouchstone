/**
 * ImpactBeliefRepository - DynamoDB Implementation
 *
...
/**
 * ImpactBeliefRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing ImpactBelief repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { ImpactBeliefRepository } from "@vouchstone/services/allocation";
...
/**
 * ImpactBeliefRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: IMPACT
 * Entity Token: IMPACT
 * SK Prefix: IMPACT
 */
export class ImpactBeliefRepositoryDdb implements ImpactBeliefRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "IMPACT";
  private readonly ENTITY_TOKEN = "IMPACT";
  private readonly SK_PREFIX = "IMPACT";
  private readonly IS_CHILD_ENTITY = false;
  private readonly CREATED_AT_FIELD = "capturedAt";
  private readonly UPDATED_AT_FIELD = "capturedAt";
  private readonly SOFT_DELETE_ENABLED = false;
  private readonly DOMAIN = "ALLOCATION";
  private readonly ENTITY_TYPE_PK = "IMPACTS";
  private generateCorrelationId(): string {
    const domainPrefix = "alc";
