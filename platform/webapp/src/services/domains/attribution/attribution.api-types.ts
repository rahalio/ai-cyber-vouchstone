 ...
 *
 * API contract types come from @vouchstone/core.
 * This file contains ONLY re-exports - no local API contract definitions.
 */

// ============================================================================
// API Type Re-exports (from @vouchstone/core)
// ============================================================================
...
export type {
  // Add types from @vouchstone/core/attribution
} from "@vouchstone/core";

// Re-export with alias for backward compatibility if needed
// export type CoreAttributionItem = AttributionItem;
