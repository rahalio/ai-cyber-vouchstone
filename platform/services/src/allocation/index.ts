/**
 * Allocation Services - Application Layer Export
 *
...
/**
 * Allocation Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for allocation domain.
 */
