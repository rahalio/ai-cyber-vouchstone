/**
 * Exercises Services - Application Layer Export
 *
...
/**
 * Exercises Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for exercises domain.
 */
